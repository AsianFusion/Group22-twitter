# -*- coding: utf-8 -*-
"""
Created on Tue Oct  1 21:32:05 2019
...
tweets = twitter_tweets.groupby('user_key', as_index = True).size().reset_index(name='retweet_count')
sorted = tweets.sort_values(['retweet_count'], ascending = False).head(10)
sorted['retweet_count']
trace0 = go.Bar(name = "Accounts Created Over Time", x = sorted.user_key, y = sorted.retweet_count)
data = ([trace0])

layout = go.Layout(
    title = "Top 10 Accounts by Retweet Count",
    yaxis = dict(
